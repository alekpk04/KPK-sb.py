        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == 'tag':
                    ...
                    cl.sendContact(to, "ubf4012671c609c2332747084066ec224")
                    ...
                    cl.sendMessage(to, "restart dono om...")
                    restartBot()
                    ...
                    try:
                        arr = []
                        owner = "ubf4012671c609c2332747084066ec224"
                   ...
                   if settings["notifikasi"] == False:
                       ...
                       if settings["lang"] == "JP":
                           cl.sendMessage(msg.to,"notif mode off")
                            ...
                            settings["siap kak"] = True
                            cl.sendMessage(to, "kirim photonya kak")
                elif text.lower() == 'ganti pp gc':
                            if msg.toType == 2:
                                if to not in settings["ok bos"]:
                                    settings["ok bos"].append(to)
